...
@section('content')
    <div class="content">
    <form class="col-md-9 m-auto" method="post" role="form" action="{{route('categories.update',$category->id)}}">
        @method('put')
        @csrf
        <div class="mb-3">
            <label for="name">Name</label>
            <input type="text" class="form-control mt-1" id="name" name="name" value="{{$category->name}}"
                   placeholder="Name">
        </div>
